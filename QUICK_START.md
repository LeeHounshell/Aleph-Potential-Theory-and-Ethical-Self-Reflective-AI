...
**All relational patterns exist.**

We call the total pattern space Aleph (𝔄).
...
𝔄 = the total relational pattern space

This differs from standard cosmology, which assumes:
